...
class TransactionAdapterClick(private val transactionList: ArrayList<TransactionDataClass>): RecyclerView.Adapter<TransactionAdapterClick.TransactionAdapterViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TransactionAdapterClick.TransactionAdapterViewHolder {
        val itemView = LayoutInflater.from(parent.context).inflate(R.layout.recycler_item_view,parent,false)
        return TransactionAdapterViewHolder(itemView)
    }
